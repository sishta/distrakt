...
build_time_vars = {'ABIFLAGS': 'm',
 ...
 'BASECPPFLAGS': '',
 'BASEMODLIBS': '',
 'BINDIR': '/opt/lib/python-3.5.3/bin',
 'BINLIBDEST': '/opt/lib/python-3.5.3/lib/python3.5',
 'BLDLIBRARY': 'libpython3.5m.a',
 'BLDSHARED': 'gcc -pthread -shared -L/opt/lib/bz2/lib     '
              '-L/opt/lib/lzma/lib     -L/opt/lib/ssl/lib     '
              '-L/opt/lib/zlib/lib     -L/opt/lib/libc6/lib     '
              '-L/opt/lib/ncurses/lib     -L/opt/lib/gpm/lib     '
              '-L/opt/lib/sqlite/lib     -L/opt/lib/readline/lib     '
 ...
 'CONFIGURE_LDFLAGS': '-L/opt/lib/bz2/lib     -L/opt/lib/lzma/lib     '
                      '-L/opt/lib/ssl/lib     -L/opt/lib/zlib/lib     '
                      '-L/opt/lib/libc6/lib     -L/opt/lib/ncurses/lib     '
                      '-L/opt/lib/gpm/lib     -L/opt/lib/sqlite/lib     '
                      '-L/opt/lib/readline/lib     '
                      '-Wl,--version-script=python.map',
 'CONFIG_ARGS': "'--prefix=/opt/lib/python-3.5.3' '--enable-ipv6' "
                "'--enable-loadable-sqlite-extensions' "
                "'--with-dbmliborder=bdb' '--with-computed-gotos' "
                "'--with-pymalloc' 'LDFLAGS=    -L/opt/lib/bz2/lib     "
                '-L/opt/lib/lzma/lib     -L/opt/lib/ssl/lib     '
                '-L/opt/lib/zlib/lib     -L/opt/lib/libc6/lib     '
                '-L/opt/lib/ncurses/lib     -L/opt/lib/gpm/lib     '
                '-L/opt/lib/sqlite/lib     -L/opt/lib/readline/lib     '
                "-Wl,--version-script=python.map'",
 'CONFINCLUDEDIR': '/opt/lib/python-3.5.3/include',
 'CONFINCLUDEPY': '/opt/lib/python-3.5.3/include/python3.5m',
 'COREPYTHONPATH': ':plat-linux',
 'COVERAGE_INFO': '/home/sources/packages/Python-3.5.3/coverage.info',
 'COVERAGE_REPORT': '/home/sources/packages/Python-3.5.3/lcov-report',
 'COVERAGE_REPORT_OPTIONS': '--no-branch-coverage --title "CPython lcov '
                            'report"',
 'CPPFLAGS': '-I. -I./Include',
 'CXX': 'g++ -pthread',
 'DESTDIRS': '/opt/lib/python-3.5.3 /opt/lib/python-3.5.3/lib '
             '/opt/lib/python-3.5.3/lib/python3.5 '
             '/opt/lib/python-3.5.3/lib/python3.5/lib-dynload',
 'DESTLIB': '/opt/lib/python-3.5.3/lib/python3.5',
 'DESTPATH': '',
 'DESTSHARED': '/opt/lib/python-3.5.3/lib/python3.5/lib-dynload',
 'DIRMODE': 755,
 ...
 'INCLDIRSTOMAKE': '/opt/lib/python-3.5.3/include '
                   '/opt/lib/python-3.5.3/include '
                   '/opt/lib/python-3.5.3/include/python3.5m '
                   '/opt/lib/python-3.5.3/include/python3.5m',
 'INCLUDEDIR': '/opt/lib/python-3.5.3/include',
 'INCLUDEPY': '/opt/lib/python-3.5.3/include/python3.5m',
 ...
 'LDFLAGS': '-L/opt/lib/bz2/lib     -L/opt/lib/lzma/lib     '
            ...
            '-L/opt/lib/libc6/lib     -L/opt/lib/ncurses/lib     '
            '-L/opt/lib/gpm/lib     -L/opt/lib/sqlite/lib     '
            '-L/opt/lib/readline/lib     -Wl,--version-script=python.map',
 'LDLAST': '',
 'LDLIBRARY': 'libpython3.5m.a',
 'LDLIBRARYDIR': '',
 'LDSHARED': 'gcc -pthread -shared -L/opt/lib/bz2/lib     '
             '-L/opt/lib/lzma/lib     -L/opt/lib/ssl/lib     '
             '-L/opt/lib/zlib/lib     -L/opt/lib/libc6/lib     '
             '-L/opt/lib/ncurses/lib     -L/opt/lib/gpm/lib     '
             '-L/opt/lib/sqlite/lib     -L/opt/lib/readline/lib     '
 ...
 'LDVERSION': '3.5m',
 'LIBC': '',
 'LIBDEST': '/opt/lib/python-3.5.3/lib/python3.5',
 'LIBDIR': '/opt/lib/python-3.5.3/lib',
 'LIBFFI_INCLUDEDIR': '',
 'LIBM': '-lm',
 'LIBOBJDIR': 'Python/',
 'LIBOBJS': '',
 'LIBPC': '/opt/lib/python-3.5.3/lib/pkgconfig',
 'LIBPL': '/opt/lib/python-3.5.3/lib/python3.5/config-3.5m',
 ...
 'MACHDEPS': 'plat-linux',
 'MACHDEP_OBJS': '',
 'MACHDESTLIB': '/opt/lib/python-3.5.3/lib/python3.5',
 'MACOSX_DEPLOYMENT_TARGET': '',
 'MAINCC': 'gcc -pthread',
 'MAJOR_IN_MKDEV': 0,
 'MAJOR_IN_SYSMACROS': 0,
 'MAKESETUP': './Modules/makesetup',
 'MANDIR': '/opt/lib/python-3.5.3/share/man',
 'MKDIR_P': '/bin/mkdir -p',
 'MODLIBS': '',
 ...
 'PY_FORMAT_SIZE_T': '"z"',
 'PY_LDFLAGS': '-L/opt/lib/bz2/lib     -L/opt/lib/lzma/lib     '
               '-L/opt/lib/ssl/lib     -L/opt/lib/zlib/lib     '
               '-L/opt/lib/libc6/lib     -L/opt/lib/ncurses/lib     '
               '-L/opt/lib/gpm/lib     -L/opt/lib/sqlite/lib     '
               '-L/opt/lib/readline/lib     -Wl,--version-script=python.map',
 ...
 'RETSIGTYPE': 'void',
 'RUNSHARED': '',
 'SCRIPTDIR': '/opt/lib/python-3.5.3/lib',
 'SETPGRP_HAVE_ARG': 0,
 'SGI_ABI': '',
 'SHELL': '/bin/sh',
 ...
 'abs_builddir': '/home/sources/packages/Python-3.5.3',
 'abs_srcdir': '/home/sources/packages/Python-3.5.3',
 'datarootdir': '/opt/lib/python-3.5.3/share',
 'exec_prefix': '/opt/lib/python-3.5.3',
 'prefix': '/opt/lib/python-3.5.3',
 'srcdir': '.'}
